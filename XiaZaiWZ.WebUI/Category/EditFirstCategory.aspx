<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditFirstCategory.aspx.cs" Inherits="XiaZaiWZ.WebUI.EditFirstCategory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content">
        <div class="panel panel-info">
            <div class="panel-heading title">编辑一级分类</div>
